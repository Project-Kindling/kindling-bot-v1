...
async def help(ctx):
  ...
  embed.add_field(name="%feedback", value="Direct message Kindling Bot with this command to anonymously send feedback to the Project Kindling moderators", inline=True)
  embed.add_field(name="%announce", value="Admin command that sends announcement content to a designated announcement channel", inline=True)
